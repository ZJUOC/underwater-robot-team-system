...
当前仓库实现 Phase 1 MVP：纳新个人档案、可解释人格标签、正式成员中心、面试、结构化逐字稿、带 OCR 的资料分析助手、Mock AI 证据分析、动态画像与证据审核。工作台暂不作为主入口，后续阶段再开发。
...
- 上传资料单文件最大 15 MB、资料包最大 40 MB；PDF 最多解析前 25 页，多页图片最多解析前 10 页。解析在内存中完成，系统只保存结构化读取报告和分析结果，不保存上传原文件。
